...
public class Contact extends AppCompatActivity {
    ...
    private void Contact() { // Contact method.
        ...
        } else if (TextUtils.isEmpty(description.getText())) { // using TextUtils to check if the filed is empty and gets the text.
            description.setError("Missing Description!"); // same as before displaying a message when the field is missing.
        } else if (TextUtils.isEmpty(email.getText())) { // using TextUtils to check if the filed is empty and gets the text.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactButton = findViewById(R.id.button); // linking the button with the xml for contact page.
